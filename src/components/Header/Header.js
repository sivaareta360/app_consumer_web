...
import { BiErrorCircle, IoIosArrowDown } from '../../assets/icons';
import logoImage from '../../assets/images/logo.png';
import './Header.css';

const Header = ({ showHelp = true, showLanguage = true }) => {
      ...
      <div className="top-right-menu">
        ...
        {showLanguage && (
          <button className="language-button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="injected-svg" role="img">
              ...
              <path d="M13.5 19V20C13.5 20.9428 13.5 21.4142 13.2071 21.7071C12.9142 22 12.4428 22 11.5 22C10.5572 22 10.0858 22 9.79289 21.7071C9.5 21.4142 9.5 20.9428 9.5 20V19" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"></path>
            </svg> UK English
            <IoIosArrowDown />
          </button>
        )}
